...
//Function to round decimal values from the weather data
function round(value, num_places) {
  return Number(Math.round(value + 'e' + num_places) + 'e-' + num_places);
}

//Adds Google map to display panel using Google Maps API
function initMap() {
...
function submitPeriod() {
    //Set period value based on selected radio button
